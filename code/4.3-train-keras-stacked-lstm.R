# creates  network of two stacked  bidirectional LSTM layers, trains it and saves it in hdf5 format in /models dir
...
model %>% 
  layer_embedding(input_dim = vocab_size, output_dim = 512, mask_zero = T) %>%
...
model %>% 
  save_model_hdf5("./models/2x-ltsm.h5")
